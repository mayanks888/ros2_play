...
if __name__ == '__main__':
    ...
    counter=0
    #######################################333333
    # template_root = "/home/mayank_s/Desktop/template/saved_temp"
    template_root = "/home/mayank_s/Desktop/template/saved_temp_img"
    ...
    for root, _, filenames in os.walk(input_folder):
        ...
        for filename in filenames:
            ...
            # if show:
                ...
                # # cv2.waitKey(1)
                # cv2.destroyAllWindows()
            cv2.imwrite("/home/mayank_s/codebase/AI/QATM/data/cust_template/myimage.jpg", frame)
    ################################################
          ...
          ############################3
            ...
            #
            # output_folder='/home/mayank_s/Desktop/template/'
            # output_folder='/home/mayank_s/Desktop/template/'
