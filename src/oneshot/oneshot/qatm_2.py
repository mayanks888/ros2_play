...
from qatm_pytorch_custom import *
import time
import copy
...
################################################
    ...
    # ////////////////////////////////////////
      ...
      template_dir = self.opt.template_images_dir
      # image_path = image_path="/home/mayank_s/playing_ros/c++/ros2_play_old/src/oneshot/oneshot/data/sample/sample.jpg"
      dataset = ImageDataset(Path(template_dir), image_path, thresh_csv='/home/mayank_s/playing_ros/c++/ros2_play_old/src/oneshot/oneshot/thresh_template.csv')
      
      print("define model...")
    #   model = CreateModel(model=models.vgg19(pretrained=True).features, alpha=self.opt.alpha, use_cuda=self.opt.cuda)
